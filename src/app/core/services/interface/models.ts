...
export interface ApproveAttendanceRequest extends AttendanceRequest {
  reason?: string;
...
export interface ProfileInfo {
  ...
  reporting_to_profile_picture: string | null | ArrayBuffer;
  empId: number;
  empCode: string;
...
// Interface for individual attendance records
...
// Interface for each entry in the 'attendance_list'
...
export interface ProfilePicDate {
  id: number;
